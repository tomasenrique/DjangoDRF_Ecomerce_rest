...
# Para usar historical record y enlazar con archivo 'base.py' en 'MIDDLEWARE'
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    historical = HistoricalRecords()  # Para relacionar enlace con el 'MIDDLEWARE' en el archivo 'base.py'
    objects = UserManager()  #
